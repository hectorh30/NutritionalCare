...
/* HectorFoodServiceBundle:Chart:mealQuery.html.twig */
class __TwigTemplate_9d2fa279e9d33608152a4a21d6ad205c extends Twig_Template
{
    protected $parent;
...
<section class=\"grid_4\">
  <div class=\"block-border\">
    <form class=\"block-content form\" id=\"";
        ...
        echo "\" action=\"";
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("_chart_meal_query"), "html");
        echo "\" method=\"post\" ";
        echo $this->env->getExtension('form')->renderEnctype($this->getContext($context, 'form'));
        echo ">
      <h1>Grafica por tiempo de comida</h1>
      ";
        // line 12
...
chart_settings: \"";
  ...
  <grid><x><alpha>10</alpha>
    ";
            // line 95
            echo "    </x><y_left><alpha>10</alpha></y_left>
  </grid>
  ...
  ";
      ...
      <title>";
                // line 104
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, 'itemInfo'), $this->getContext($context, 'i'), array(), "array", false), "name", array(), "any", false), "html");
                echo "</title>
      <color>";
                // line 105
                echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute($this->getContext($context, 'itemInfo'), $this->getContext($context, 'i'), array(), "array", false), "color", array(), "any", false), "html");
                echo "</color>
...
";
    ...
    {
        return "HectorFoodServiceBundle:Chart:mealQuery.html.twig";
    }
