...
class appProdDebugProjectContainer extends Container
{
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/assetic/config'), true)));
    ...
    {
        return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(array(0 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetManagerCacheWarmer($this), 1 => new \Symfony\Bundle\FrameworkBundle\CacheWarmer\RouterCacheWarmer($this->get('router.real')), 2 => new \Symfony\Bundle\DoctrineBundle\CacheWarmer\ProxyCacheWarmer($this), 3 => new \Symfony\Bundle\AsseticBundle\CacheWarmer\AssetWriterCacheWarmer($this, new \Assetic\AssetWriter('/home/hectorh30/sfprojects/NutritionalCare/app/../web'))));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnection_ConfigurationService()
    {
        ...
        $instance->setSQLLogger(new \Symfony\Bundle\DoctrineBundle\Logger\DbalLogger($this->get('monolog.logger.doctrine')));
    ...
    protected function getDoctrine_Orm_DefaultConfigurationService()
    {
        ...
        $instance->setProxyDir('/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file.temporary_storage'] = new \Symfony\Component\HttpFoundation\File\SessionBasedTemporaryStorage($this->get('session'), '0c472b1bd1045d607c00bf6b9ebcc2db09cd76b9', '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/upload');
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/hectorh30/sfprojects/NutritionalCare/app/logs/prod.log', 100, false);
    }
    ...
    {
        return $this->services['router.cached'] = new \Symfony\Bundle\FrameworkBundle\Routing\CachedRouter('/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new', 'appprodUrlMatcher', 'appprodUrlGenerator');
    }
    ...
    {
        return $this->services['router.real'] = new \Symfony\Component\Routing\Router(new \Symfony\Bundle\FrameworkBundle\Routing\LazyLoader($this, 'routing.loader.real'), '/home/hectorh30/sfprojects/NutritionalCare/app/config/routing.yml', array('cache_dir' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appprodUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appprodUrlMatcher'));
    }
    ...
    {
        return $this->services['translator.real'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => 'php', 'translation.loader.yml' => 'yml', 'translation.loader.xliff' => 'xliff'), array('cache_dir' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/translations', 'debug' => true), $this->get('session'));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'cache' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/twig', 'charset' => 'UTF-8'));
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/twig',
                'charset' => 'UTF-8',
            ),
            ...
            'doctrine.orm.proxy_dir' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/doctrine/orm/Proxies',
            ...
            'assetic.cache_dir' => '/home/hectorh30/sfprojects/NutritionalCare/app/cache/prod_new/assetic',
